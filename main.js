...
function displayPlayerButtons() {
  ...
  playerOneButton.style.padding = "10px 10px";
  playerOneButton.style.fontSize = "1em";

  playerOneButton.style.position = "absolute";
  playerOneButton.style.bottom = "20%";
  playerOneButton.style.left = "55%";
  ...
  playerTwoButton.style.padding = "10px 10px";
  playerTwoButton.style.fontSize = "1em";
  playerTwoButton.style.position = "absolute";
